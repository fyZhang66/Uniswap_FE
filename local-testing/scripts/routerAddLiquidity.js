...
// Contract ABIs
const TestTokenABI =
  require("../artifacts/contracts/ERC20.sol/TestToken.json").abi;
const UniswapV2PairABI =
  require("../artifacts/contracts/UniswapV2Pair.sol/UniswapV2Pair.json").abi;
const UniswapV2RouterABI =
  require("../artifacts/contracts/UniswapV2Router.sol/UniswapV2Router.json").abi;
...
async function main() {
  try {
    ...
    const pairAddress = await publicClient.readContract({
      address: factory,
      abi: require("../artifacts/contracts/UniswapV2Factory.sol/UniswapV2Factory.json")
        .abi,
    ...
    if (
      ...
      console.log("Liquidity token address:", pairAddress);
